...
public class ControllerMockitoTest {
	...
	public void TestAddAdmin()
	{
		...
		role1.add(new Role("1","Admin"));
		 admin = new Admin ("1","vishal","Kumar","singh","xyz@gmail.com","1234",role1,"user");
	...
	public void TestFindByName()
	{
		Set<Role> role1 = new HashSet<Role>();
		role1.add(new Role("1","Admin"));
		 admin = new Admin ("1","vishal","Kumar","singh","xyz@gmail.com","1234",role1,"vishal");
		 when(service.findUserName("vishal")).thenReturn(admin);
		 assertEquals(admin,controller.getByName("vishal"));
	...
	public void TestDeleteAdmin()
	{
		Set<Role> role1 = new HashSet<Role>();
		role1.add(new Role("1","Admin"));
		 admin = new Admin ("1","vishal","Kumar","singh","xyz@gmail.com","1234",role1,"singh");
