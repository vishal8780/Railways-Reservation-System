...
public class ControllerMockitoTest {
	...
	/*
	 * @Test public void TestCreateTrain()throws Exception { t = new Train
	 * (12121,"Bandra","bandra","Mumbai",400,"6.45", new
	 * Fare(5898.0,3564.0,2454.0,675.0));
	 * 
	...
	/*
	 * @Test public void TestUpdateTrain() throws Exception { t = new Train
	 * (12121,"Bandra","bandra","Mumbai",400,"6.45", new
	 * Fare(5898.0,3564.0,2454.0,675.0));
	 * when(service.getById(12121)).thenReturn(t); when(service.updateById(12121,
	 * t)).thenReturn(t);
	 * 
	 * 
	 * ObjectMapper mapper = new ObjectMapper(); String jsonbody =
